...
$querySect = "SELECT karyawan.*, sect.*
                  ...
                  WHERE karyawan.cwoc = '$cwoc'AND karyawan.resdate IS NULL
                  GROUP BY sect.desc";
...
<head>
    ...
    <title>Real Time Man Power | Seksi <?php echo $cwoc; ?></title>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Departemen <?php echo $cwoc; ?></h3>
                  ...
                  while ($user_data = mysqli_fetch_array($resultSect)) {
                    ...
                    echo "<td><a href='subsect.php?sect={$user_data['sect']}' style='color:black;'>" . $user_data['desc'] . "</td>"; // Ubah sesuai dengan nama kolom yang benar
                    echo "<td>" . ($total_karyawan = isset($DashboardBySect[$sect]['total_karyawan']) ? $DashboardBySect[$sect]['total_karyawan'] : 0) . "</td>";
                    echo "</tr>";
                  }
                  ?>
                                </tbody>
