...
if (isset($_GET['show_all'])) {
    ...
    if ($selectedYear !== null) {
        ...
        if ($selectedMonth !== null) {
            ...
            $judulDaftar = "Daftar Karyawan Keluar $startMonth - $endMonth $selectedYear";
        } else {
            // Determine default month range based on the current month
            if ($currentMonth >= 1 && $currentMonth <= 4) {
        ...
        $judulDaftar = "Daftar Karyawan Keluar";
    }
}
...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
    <div class="wrapper">
        ...
        <!-- <div class="preloader flex-column justify-content-center align-items-center">
            <img src="../../asset/img/k-logo.jpg" alt="AdminLTELogo" height="100" width="100">
        </div> -->
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Riwayat Karyawan Keluar</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="../MPS/dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active">Riwayat Karyawan Keluar</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                    ...
                                    if (mysqli_num_rows($resultOut) > 0) {
                                        while ($row = mysqli_fetch_assoc($resultOut)) {
                                            ...
                                            if (strpos($row['emno'], 'K') === 0) {
                                                echo "Kontrak";
                                            } elseif (preg_match('/^0/', $row['emno']) || preg_match('/^[0-9]+$/', $row['emno'])) {
                                                echo "Permanen";
